// Deprecated stub — all logic moved to yahooFinanceService.js.
module.exports = require('./yahooFinanceService');
// (file kept to avoid breaking any cached require paths)
